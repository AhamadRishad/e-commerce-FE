  ...
  return (
    ...
    <div className="h-full  mx-auto flex items-center justify-between px-4">
      ...
      <div className=" flex items-center gap-7">
       ...
       
        {
          menuDisplay && (
            <div className="absolute bg-white bottom-0 top-11 h-fit p-2 shadow-lg rounded">
             <nav>
              <Link to={"/admin/my-upload"} className="whitespace-nowrap hidden md:block hover:bg-slate-100 p-2 rounded">manager panel</Link>
        ...
        <div>
          <Link to={"/admin/login"} className="px-3 py-1 rounded-full text-white bg-red-600 hover:bg-red-700">Login</Link>
        </div>
